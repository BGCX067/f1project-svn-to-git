<?php
#=====================================================================
#	Filename: admin/attachments/uthumb.php
#	Note	: 批量更新缩略图
#	Version : 3.0
#	Author  : qinggan
#	Update  : 2008-08-16
...
$k = intval($k);
$f_url = "admin.php?file=attachments&act=uthumb&id=".$id;
...
if($updateId)
{
	...
	{
		$rs["thumbfile"] = $GD->thumb($rs["folder"].$rs["filename"]);
		#[更新SQL数据库]
