<?php
#=====================================================================
#	Filename: admin/download/list.php
#	Note	: 下载文件列表
#	Version : 3.0
#	Author  : qinggan
#	Update  : 2008-07-12
...
$page_url = "admin.php?file=download&act=list";
if($cateid)
{
...
$C_Msg = $CF->build("msg");
$C_Msg->set("fields","id,cateid,subject,style,author,postdate,hits,taxis,thumb,istop,isvouch,isbest,ifcheck,url");
