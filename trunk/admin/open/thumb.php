...
if(!$inputname)
{
	$inputname = $_SESSION["tmp_input_name"] ? $_SESSION["tmp_input_name"] : "thumb";
}
$_SESSION["tmp_input_name"] = $inputname;

#[取得页码]
$page_url = "admin.php?file=open&act=thumb&input_name=".$inputname;
