...
<!-- inc:inc.head2 -->
	...
	<div id="content-layout">
		...
		<h2 id="com" class="title">广物福昌</h2>
			<ul id="side-company">
				<li><a id="side-1" class="" href="special.php/2.html" >关于福昌</a></li>
				<li><a id="side-2" class="" href="special.php/15.html" >企业荣誉</a></li>
				<li><a id="side-3" class="" href="special.php/3.html" >团队活动</a></li>
			</ul>
</div>
		  ...
		  <div id="content">
		    <div align="center">
		      <table border="0" cellpadding="0" cellspacing="0" class="TableMain">
                ...
                <tr>
                  <td align="center" class="ContentComFont"><p>{:$content}</p>
