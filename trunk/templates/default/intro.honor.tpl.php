...
<!-- inc:inc.head2 -->
	...
	<div id="content-layout">
		...
		<h2 id="com" class="title">广物福昌</h2>
			<ul id="side-company">
				<li><a id="side-1" href="special.php/2.html" >关于福昌</a></li>
				<li><a id="side-2" class="on" href="special.php/15.html" >企业荣誉</a></li>
				<li><a id="side-3" href="special.php/3.html" >团队活动</a></li>			
			</ul>
</div>
