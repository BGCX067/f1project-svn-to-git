...
function ShowCalendar(idname){
	...
	table+="</select>";
    table+="</td>";
    table+="<td style='border-bottom:1px solid #0066FF; background-color:#84AACE; font-weight:bold; font-family:宋体,Arial,Tahoma; font-size:16px; padding-top:2px; color:#4477FF; cursor:pointer' align='center' title='关闭' onClick='javascript:HiddenCalendar()'>×</td>";
    table+="</tr>";
