<?php
#=====================================================================
#	Filename: class/db/mysql/book.php
#	Note	: 留言信息操作
#	Version : 3.0
#	Author  : qinggan
#	Update  : 2008-07-13
...
class C_Book
{
	...
	function UpdateBook($array,$id=0)
	{
		...
		$sql = "UPDATE ".$this->table." SET user='".$array["user"]."',subject='".$array["subject"]."',content='".$array["content"]."',postdate='".$array["postdate"]."',email='".$array["email"]."',ifcheck='".$array["ifcheck"]."',reply='".$array["reply"]."',replydate='".$array["replydate"]."' WHERE id='".$id."'";
	...
	function InsertBook($array)
	{
		...
		$sql = "INSERT INTO ".$this->table."(user,subject,content,postdate,email,ifcheck,reply,replydate) VALUES('".$array["user"]."','".$array["subject"]."','".$array["content"]."','".$array["postdate"]."','".$array["email"]."','".$array["ifcheck"]."','".$array["reply"]."','".$array["replydate"]."')";
